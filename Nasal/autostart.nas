...
var coldAndDark = func {
    ...
    setprop("/controls/hydraulic/edp-shutoff[0]", 0);
    setprop("/controls/hydraulic/edp-shutoff[1]", 0);
    setprop("/controls/hydraulic/ptu", -1);
    setprop("/controls/hydraulic/ehp[0]", -1);
    setprop("/controls/hydraulic/ehp[1]", -1);
    setprop("/controls/hydraulic/ehp[2]", -1);
    setprop("/controls/hydraulic/ehp[3]", -1);
...
var groundPowered = func {
    ...
    setprop("/controls/hydraulic/ehp[0]", 0);
    setprop("/controls/hydraulic/ehp[1]", 0);
    setprop("/controls/hydraulic/ehp[2]", 0);
    setprop("/controls/hydraulic/ehp[3]", 0);
    setprop("/controls/switches/chocks", 1);
    setprop("/controls/switches/cones", 1);
    setprop("/controls/switches/cones", 1);
};
